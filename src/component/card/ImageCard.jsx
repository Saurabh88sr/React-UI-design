...
const ImageCard = () => {
  return (
    <div className="max-w-sm rounded-3xl p-3 overflow-hidden shadow-lg bg-white">
      <div className="px-2 py-4">
        <div className="flex justify-between">
          <h2 className="font-bold text-xl mb-2">Main Heading</h2>
          <div className="text-white p-2 rounded-full bg-gray-700"><ArrowOutwardOutlinedIcon/></div>
        </div>
